...
use Univer\Blog\Model\ResourceModel\Post\Collection;
use Univer\Blog\Model\ResourceModel\Post\CollectionFactory;
...
class PostList extends AbstractBlock
{
    ...
    protected function _prepareLayout()
    {
        ...
        $metaDescription = ($this->config->getMetaDescription()) ?: 'Blog';
