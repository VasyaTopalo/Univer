...
namespace Univer\Blog\Controller;

use Univer\Blog\Model\AuthorFactory;
use Univer\Blog\Model\CategoryFactory;
use Univer\Blog\Model\Config\Config;
use Univer\Blog\Model\PostFactory;
use Univer\Blog\Model\TagFactory;
    ...
    public function match(RequestInterface $request)
    {
        ...
        if ($urlKey) {
            if ($explodedIdentifier[0] == $urlKey && !isset($explodedIdentifier[1])) {
                $request->setModuleName('univer_blog');
            ...
            if ($explodedIdentifier[0] == $urlKey || $explodedIdentifier[0] == 'univer_blog') {
                if (!empty($postId)) {
                    $request->setModuleName('univer_blog');
