...
use Univer\Blog\Model\Category as CategoryModel;
...
class Category extends AbstractResourceModel
{
    ...
    {
        $this->_init('univer_blog_category', 'category_id');
    }
    ...
    {
        return $this->getStoreIds('univer_blog_category_store', 'category_id', $id);
    }
    ...
    {
        $table = $this->getTable('univer_blog_category_store');
    ...
    public function checkUrlKeyAndGetId($url_key)
    {
        ...
        return $this->getObjectIdByStore($categoryIds, 'univer_blog_category_store', 'category_id');
    }
    ...
    protected function _beforeSave(AbstractModel $object)
    {
        ...
        if (!$this->checkUniqueUrlKey($object, $existingIds, 'univer_blog_category_store', 'category_id')) {
