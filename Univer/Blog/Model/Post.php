...
namespace Univer\Blog\Model;

use Univer\Blog\Api\Data\PostInterface;
use Univer\Blog\Model\Post\File;
...
class Post extends AbstractModel implements IdentityInterface, PostInterface
{
    ...
    const CACHE_TAG = 'univer_blog_post';

    protected $_cacheTag = 'univer_blog_post';

    protected $_eventObject = 'univer_blog_post';

    protected $_eventPrefix = 'univer_blog_post';
    ...
    {
        $this->_init('Univer\Blog\Model\ResourceModel\Post');
    }
    ...
    public function getPostUrl()
    {
        ...
        $postUrl = (!empty($prefixUrl)) ? '/' . $prefixUrl . '/' . $urlKey : '/univer_blog' . '/' . $urlKey;
        return $postUrl;
    }
